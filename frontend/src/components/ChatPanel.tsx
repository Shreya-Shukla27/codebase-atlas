...
export default function ChatPanel({ messages, loading, onSend, onClose }: Props) {
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div className="fixed inset-0 z-50 flex flex-col md:relative md:inset-auto md:w-80 md:z-auto border-l"
        style={{ background: "#0a0f1e", borderColor: "#1a2040" }}>
        {/* Header */}
        <div className="h-12 flex items-center justify-between px-4 border-b flex-shrink-0" style={{ borderColor: "#1a2040" }}>
        ...
        {/* Input */}
        <div className="p-3 border-t flex-shrink-0" style={{ borderColor: "#1a2040" }}>
